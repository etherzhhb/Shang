...
print("freq_mean: %d total_cycles: %d total_time: %d total_les: %d total_mults: %d total_equ_les: %d delay-area: %d" %(freq_mean,cycles_sum,delay_sum, les_sum, all_mult9_sum, all_equ_le_sum, all_equ_le_sum * delay_sum))
book.save(OutFile)	
