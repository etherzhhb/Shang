...
#include"stdio.h"
#include"include/main1024_bit_reduct.h"

#include "include/input_data/twids1024-13.dat" /* precalculated twiddle factors 
...
void
main1024_bit_reduct(STORAGE_CLASS TYPE *int_pointer)
...
main()
{
  ...
  main1024_bit_reduct(&input_data[0]); 
