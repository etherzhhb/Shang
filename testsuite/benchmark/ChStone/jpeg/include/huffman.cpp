 ...
 */
int
huff_make_dhuff_tb(int *p_xhtbl_bits, int *p_xhtbl_huffval, int p_dhtbl_ml, int *p_dhtbl_maxcode, int *p_dhtbl_mincode, int *p_dhtbl_valptr)
{
 ...
 */
int
DecodeHuffman(int *Xhuff_bits, int *Xhuff_huffval, int Dhuff_ml, int *Dhuff_maxcode, int *Dhuff_mincode, int *Dhuff_valptr)
{
    int code,l,p;
